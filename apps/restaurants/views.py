...
class RestaurantViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter('limit', openapi.IN_QUERY, description='Max results to return (default 20)', type=openapi.TYPE_INTEGER, required=False),
            openapi.Parameter('radius', openapi.IN_QUERY, description='Search radius in meters (default 2000)', type=openapi.TYPE_INTEGER, required=False),
            openapi.Parameter('search_limit', openapi.IN_QUERY, description='Per-location upstream search limit (default 20)', type=openapi.TYPE_INTEGER, required=False),
        ],
        responses={
                        ...
                        "recommendations": [
                            {
                                ...
                                "latitude": 40.7128,
                                "longitude": -74.006,
                                "reference_location": {"name": "Home Area", "latitude": 40.713, "longitude": -74.01}
                            },
                            {
                                ...
                                "latitude": 41.8781,
                                "longitude": -87.6298,
                                "reference_location": {"name": "Work Area", "latitude": 41.88, "longitude": -87.63}
                            }
                        ],
                        "user_context": {
                        ...
                        "recommendations": [
                            {
                                ...
                                "latitude": 34.0522,
                                "longitude": -118.2437,
                                "reference_location": {"name": "Home Area", "latitude": 34.05, "longitude": -118.24}
                            }
                        ],
                        "user_context": {
                            "frequent_restaurants": [
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter('limit', openapi.IN_QUERY, description='Max results per type (default 10)', type=openapi.TYPE_INTEGER, required=False),
            openapi.Parameter('radius', openapi.IN_QUERY, description='Search radius in meters (default 2000)', type=openapi.TYPE_INTEGER, required=False),
            openapi.Parameter('search_limit', openapi.IN_QUERY, description='Per-location upstream search limit (default 20)', type=openapi.TYPE_INTEGER, required=False),
        ],
        responses={
