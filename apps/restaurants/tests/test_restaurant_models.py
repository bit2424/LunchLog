...
class TestRestaurantModel:
    ...
    def test_restaurant_cuisine_filtering(self):
        ...
        assert italian_restaurants.count() == 2  # italian_restaurant and mixed_restaurant
        
        chinese_restaurants = Restaurant.objects.filter(cuisines__name='Chinese')
        assert chinese_restaurants.count() == 2  # chinese_restaurant and mixed_restaurant
        
        # Test case-insensitive filtering
        italian_case_insensitive = Restaurant.objects.filter(cuisines__name__icontains='italian')
