...
class TestRecommendationAPIEndpoints:
    ...
    @patch('apps.restaurants.services.GooglePlacesService.get_recommendations_near_location')
    ...
    @pytest.mark.integration
    @patch('apps.restaurants.services.GooglePlacesService.get_recommendations_near_location')
    def test_cheap_recommendations_endpoint(self, mock_recommendations, setup_user_data):
    ...
    @pytest.mark.integration
    @patch('apps.restaurants.services.GooglePlacesService.get_recommendations_near_location')
    def test_cuisine_match_recommendations_endpoint(self, mock_recommendations, setup_user_data):
    ...
    def test_recommendations_with_limit_parameter(self, setup_user_data):
        ...
        with patch('apps.restaurants.services.GooglePlacesService.get_recommendations_near_location') as mock_rec:
