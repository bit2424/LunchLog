...
class TestUserCuisineStatModel:
    ...
    def test_cuisine_stat_creation(self):
        ...
        stat = UserCuisineStat.objects.create(
            user=user,
            cuisine=cuisine,
            visit_count=3
        )
...
class TestVisitTrackingService:
    ...
    def test_get_user_cuisine_stats(self):
        ...
        UserCuisineStat.objects.create(user=user, cuisine=italian_cuisine, visit_count=8)
        UserCuisineStat.objects.create(user=user, cuisine=chinese_cuisine, visit_count=4)
